...
#define WINDOW_NAME "Linear Constraint Visualization"
...
int main() {
    ...
    my_world.register_component<Linear_Component>();
    ...
    Velocity_Component init_particle_vel1 = {rk_id, Eigen::Vector2f(1.0, 1.0)}; 
    ...
    entity_id++; 
    Linear_Component particle1_constr = {entity_id, rk_id, 1.0, 0.0}; 
    ...
    my_world.add_component<Linear_Component>(particle1_constr); 
