...
void Motion_System(ECS_Manager &world, double dt){
    ...
    for (auto it = world.get_component_begin<Motion_Component>(); 
        ...
        Eigen::Vector2d temp_pos = world.get_component<Position_Component>(it->entity_id)->position;
        
        /*
        Eigen::Vector2d new_pos  = world.get_component<Position_Component>(it->entity_id)->position + 
        ...
        */
        /*
        Eigen::Vector2d new_pos = 2*world.get_component<Position_Component>(it->entity_id)->position - 
        ...
        */
        ...
        Eigen::Vector2d new_vel = world.get_component<Velocity_Component>(it->entity_id)->velocity + 
